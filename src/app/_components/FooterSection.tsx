...
export default function FooterSection() {
    return (
        <footer className="py-12 sm:py-20 md:py-16 lg:py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    <Link
                        href="https://www.instagram.com/maisonprivee.official/"
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Maison Privée, All rights reserved</span>
            </div>
        </footer>
    )
}
