...
export default function HomeProducts() {
    return (
            <section className="px-8 pt-8 pb-16 text-center">
                <h2 className={`${forum.className} text-6xl mb-20`}>Nossos Produtos</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto min-h-[300px]">
                    {products.map((p, i) => (
                        <ProductCard
                            key={i}
                            image={p.imagens[0]}
